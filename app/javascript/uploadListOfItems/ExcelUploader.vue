    ...
    <form enctype="multipart/form-data" novalidate>
      <div class="dropbox mb-5">
        <input type="file"
               ...
               class="input-file">
        <p>
          Drop your excel file here<br> or click to browse
        </p>
      </div>
    </form>
...
<script>
  export default {
    ...
    mounted () {
      if (this.request_for_tender.excel_file) {
        this.uploadedFiles.push(this.request_for_tender.excel_file)
      }
    },
    ...
    methods: {
      ...
      filesChange (fieldName, fileList) {
        ...
        Array.from(fileList)
          .map(file => {
            ...
            formData
              .append('excel_file[original_file_name]', file.name)
      ...
      save (project_document) {
        ...
        this.uploadedFiles = [project_document]
        ...
        this.$http.post(
          ...
          .then(response => {
            this.uploadedFiles = [response.body]
