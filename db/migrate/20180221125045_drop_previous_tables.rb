class DropPreviousTables < ActiveRecord::Migration[5.1]
  def change
    drop_table "admins", force: :cascade do |t|
    ...
    drop_table "answer_boxes", force: :cascade do |t|
    ...
    drop_table "answer_documents", force: :cascade do |t|
    ...
    drop_table "boqs", force: :cascade do |t|
    ...
    drop_table "broadcast_messages", force: :cascade do |t|
      t.text "content"
    ...
    drop_table "chatrooms", force: :cascade do |t|
      t.bigint "request_for_tender_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    drop_table "excels", force: :cascade do |t|
      t.string "document"
      t.bigint "request_for_tender_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    drop_table "filled_items", force: :cascade do |t|
      t.bigint "participant_id"
      t.bigint "item_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    drop_table "item_tags", id: false, force: :cascade do |t|
      t.integer "item_id"
      t.integer "tag_id"
    ...
    drop_table "items", force: :cascade do |t|
      t.string "name"
      t.text "description"
      t.string "rate"
      t.string "amount"
    ...
    drop_table "messages", force: :cascade do |t|
      t.text "content"
    ...
    drop_table "pages", force: :cascade do |t|
      t.string "name"
      t.bigint "boq_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    drop_table "participants", force: :cascade do |t|
    ...
    drop_table "participants_requests", id: false, force: :cascade do |t|
    ...
    drop_table "project_documents", force: :cascade do |t|
      t.string "document"
      t.bigint "request_for_tender_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    drop_table "quantity_surveyor_rates", force: :cascade do |t|
      t.string "sheet_name"
      t.float "rate"
    ...
    drop_table "quantity_surveyors", force: :cascade do |t|
      t.string "email", default: "", null: false
      t.string "encrypted_password", default: "", null: false
    ...
    drop_table "questions", force: :cascade do |t|
      t.bigint "request_for_tender_id"
      t.integer "number"
      t.string "title"
      t.text "description"
    ...
    drop_table "rates", force: :cascade do |t|
      t.bigint "boq_id"
      t.string "sheet_name"
      t.decimal "value"
      t.datetime "created_at", null: false
    ...
    drop_table "request_for_tenders", force: :cascade do |t|
    ...
    drop_table "required_documents", force: :cascade do |t|
      t.bigint "request_for_tender_id"
      t.string "title"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    ...
    drop_table "winners", force: :cascade do |t|
      t.string "email"
      t.string "first_name"
      t.string "last_name"
      t.string "company_name"
    ...
    drop_table "workbooks", force: :cascade do |t|
      t.text "text"
      t.bigint "request_for_tender_id"
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
